...
<template>
    <div class="w-[40em] max-w-[95vw] min-h-10em sm:h-[calc(100vh_-_10em)] border-2 border-black rounded-lg relative">
        ...
        <caption class="font-[Oswald] font-[300] text-lg text-ellipsis overflow-hidden text-nowrap w-11/12 text-left absolute bottom-[7em] sm:bottom-[4em] left-4 text-white">{{ post.body }}</caption>
